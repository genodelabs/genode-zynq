...
[codeberg.org](https://codeberg.org/genodelabs/genode-zynq) and it will no
...
```
zynq$ git remote set-url origin https://codeberg.org/genodelabs/genode-zynq
zynq$ git fetch origin
zynq$ git checkout origin/main
zynq$ git switch -c main
```

Alternatively, you may also create a fresh clone:

```
$ git clone https://codeberg.org/genodelabs/genode-zynq zynq
```
