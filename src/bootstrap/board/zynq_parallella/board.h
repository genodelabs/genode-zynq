...
#ifndef _SRC__BOOTSTRAP__BOARD__ZYNQ_PARALLELLA__BOARD_H_
#define _SRC__BOOTSTRAP__BOARD__ZYNQ_PARALLELLA__BOARD_H_

#include <hw/spec/arm/zynq_parallella_board.h>
...
namespace Board {
	...
	using namespace Hw::Zynq_parallella_board;
...
#endif /* _SRC__BOOTSTRAP__BOARD__ZYNQ_PARALLELLA__BOARD_H_ */
