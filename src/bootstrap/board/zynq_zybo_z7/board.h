...
#ifndef _SRC__BOOTSTRAP__BOARD__ZYNQ_ZYBO_Z7__BOARD_H_
#define _SRC__BOOTSTRAP__BOARD__ZYNQ_ZYBO_Z7__BOARD_H_
...
#endif /* _SRC__BOOTSTRAP__BOARD__ZYNQ_ZYBO_Z7__BOARD_H_ */
