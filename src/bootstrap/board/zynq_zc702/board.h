...
#ifndef _SRC__BOOTSTRAP__BOARD__ZYNQ_ZC702__BOARD_H_
#define _SRC__BOOTSTRAP__BOARD__ZYNQ_ZC702__BOARD_H_

#include <hw/spec/arm/zynq_zc702_board.h>
...
namespace Board {
	...
	using namespace Hw::Zynq_zc702_board;
...
#endif /* _SRC__BOOTSTRAP__BOARD__ZYNQ_ZC702__BOARD_H_ */
