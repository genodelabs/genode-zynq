...
#ifndef _INCLUDE__DRIVERS__NIC__CADENCE_GEM__SYSTEM_CONTROL_H_
#define _INCLUDE__DRIVERS__NIC__CADENCE_GEM__SYSTEM_CONTROL_H_
...
#endif /* _INCLUDE__DRIVERS__NIC__CADENCE_GEM__SYSTEM_CONTROL_H_ */
