...
#ifndef _SRC__INCLUDE__HW__SPEC__ARM__ZYNQ_PARALLELLA_H_
#define _SRC__INCLUDE__HW__SPEC__ARM__ZYNQ_PARALLELLA_H_
...
#endif /* _SRC__INCLUDE__HW__SPEC__ARM__ZYNQ_PARALLELLA_H_ */
